%% function: use newton's method to find the local minimum
% author: Yan Ou
% date: 20130423

function [localMinPoint, localMin] = NewtonMethod(fun,x0,A,b,constantValue)
% set initial value
...
for i = 1:maxStep
    ...
    h = HessianCostFunc(fun,x0,constantValue);
    p = -h\g';
    % get next step point
    xp = x0;
    % line search
